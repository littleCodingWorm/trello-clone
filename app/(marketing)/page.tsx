  ...
  return (
    <main className="flex h-full w-full items-center justify-center p-4">
      <div className="flex flex-col items-center justify-center gap-4 text-center">
        <div className="flex items-center justify-center gap-2 rounded-full bg-amber-100 px-3 py-2 font-mont text-sm font-[600] uppercase text-amber-700 md:px-4 md:py-3 md:text-base">
          <Medal />
          <span>No1 task management</span>
        </div>
        <h1 className="flex flex-col items-center justify-center gap-4 font-mont text-4xl font-[700] md:text-5xl">
